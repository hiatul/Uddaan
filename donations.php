...
<html>
    ...
    <body style="background-image: url(images/page1/backg.jpeg); background-attachment: fixed; background-repeat: no-repeat;background-size: cover;">
        ...
        <div class="col-12"  style="position: fixed; z-index: 99; height: auto; background: white; box-shadow: 0px 0px 10px 1px rgba(0,0,0,0.8);">
            ...
            <div class="col-12 menu">
                <ul class="lifontsize">
                    ...
                    <li style=" border-bottom:4px solid   green;"><a href="donations.php">Donations</a></li>
        ...
        <div class="col-12 main" >
            ...
            <div class="col-11" style="margin: auto; float: none; margin-top: 10px; height: auto; text-align: center; text-shadow: 5px 5px 15px 100px rgba(0,0,0,1); color: white; "><h1>Want to be a helping hand ?</h1></div>
            <div class="col-11" style="margin: auto; float: none; margin-top: 10px; height: auto; overflow: hidden; padding: 10px;  text-align: center; color: white; font-size: 24px;">
                <div class="col-6" style="background: rgba(0,0,0,0.7); height: auto; float: left; padding: 10px;">
                    <h4>Donation Form</h4>
                    <p id="error1" style="color: tomato; margin-top: 10px; font-size: 20px; display: block;"><?php echo $error; ?></p>

                  
                    <form style="margin-top: 30px;" method="POST" action="DonationInsert.php" enctype="multipart/form-data">
                            ...
                            <div  style=" width: 90%; height: auto; padding-left: 5px; padding-right: 5px; border-radius: 5px; margin: auto; margin-top: 10px; float: none; overflow: hidden; background: white; " >
                                    ...
                                    <input type="text" name="address" placeholder="Address" style=" float: left; width: 80%; font-size: 15px;padding: 5px; border-radius: 5px;  outline: none; border: none;" required>
                            ...
                            <div  style=" width: 90%; height: auto; padding-left: 5px; padding-right: 5px; border-radius: 5px; margin: auto; margin-top: 10px; float: none; overflow: hidden; background: white; " >
                                    ...
                                    <input type="number" name="phone" placeholder="Phone" style=" float: left; width: 80%; font-size: 15px;padding: 5px; border-radius: 5px;  outline: none; border: none;" required>

                            </div>
                            
                            <div  style=" width: 90%; height: auto; padding-left: 5px; padding-right: 5px; border-radius: 5px; margin: auto; margin-top: 10px; float: none; overflow: hidden; background: white; " >
                                <img style="float: left; " width="26" height="26" src="images/contactus/donate_96px.png">
                                    <input type="text" name="item" placeholder="What Do You Want To Donate" style=" float: left; width: 80%; font-size: 15px;padding: 5px; border-radius: 5px;  outline: none; border: none;" required>

                            </div>
                            
                            <div style=" width: 90%; margin: auto; margin-top: 5px; height: auto;  float: none; overflow: hidden;">
                                <div class="col-11" style="padding-top: 5px;  height: auto;  margin: auto;overflow: hidden; float: left;">
                                    <p style="text-align: left; height: 26px; float: left; width: 250px; font-size: 18px;">To Whome You Want to Donate</p>
                                    <select name="ngo" style="font-size: 15px; border-radius: 5px; float: left; outline: none; border: none; width: 180px;" required>
<?php
...
?>
                            ...
                            <div  style=" width: 90%; height: auto; padding-left: 5px; padding-right: 5px; border-radius: 5px; margin: auto; margin-top: 10px; float: none; overflow: hidden; background: white; " >
                                ...
                                <input type="file" name="photo" style="color: black; float: left; width: 80%; font-size: 15px;padding: 5px; border-radius: 5px;  outline: none; border: none;" required>
                            </div>
                            
                            
                            <div style=" height: auto;  clear: both; margin: auto; float: none; margin-top: 20px;">
                               
                                <input type="submit" style="cursor: pointer; color: white; width: 60%; position: relative; border: none; box-shadow: 0px 0px 6px 2px rgba(0,0,0,0.3);  background: #129212; height: 40px; border-radius: 10px;">
                            </div>
                ...
                <div class="col-6 part2" >
                    <h3>NOBODY BECOMES POOR BY GIVING</h3>
                    <p style="margin-top: 20px;">"The best feeling of HAPPINESS is when you are happy because you have made somebody else HAPPY"</p>
                    <p style="margin-top: 20px;">From fancy clothes to expensive cars, there are many other ways you can spend your hard earned rupees, and i.e. donation. When it comes to the word “DONATION”, people tends to research the issues related to that organization. So considering this problem, we have come up with the solution. Anyone who feels like transforming a poor’s life by donating in any form, then UDDAAN is the best platform for them.</p>
                </div>
...
<!--                <div class="col-4" style="height: 200px; background: #D4FFD4; overflow: hidden;">-->

<h2 style="background: white;">Items Donated</h2>
<?php
                $con = new mysqli("localhost","varunk_13","12345","Uddaan");
                                        ...
                                        if($con->connect_error)
                                            ...
                                            {
                                                $cont=1;
                                                 $command1="Select * from Donation ORDER BY Id DESC";
                                                    $m=$con->query($command1);
                                                    while(($data=$m->fetch_assoc()))
                                                    {
...
<div class="col-12" style="background: white; height: 40px; padding: 5px;">
    <a href="DonatorsInfo.php"><img src="images/info.png" width="30" height="30"></a>
</div>
            </div>
<!--                <div class="col-4" style="height: 200px; background: #D4FFD4;"></div>
                <div class="col-4" style="height: 200px; background: #D4FFD4;"></div>-->
