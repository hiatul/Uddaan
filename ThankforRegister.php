    ...
    <body style="background-image: url(images/page1/backg.jpeg); background-attachment: fixed; background-repeat: no-repeat;background-size: cover;">
        ...
        <div class="col-12"  style="position: fixed; z-index: 99; height: auto; background: white; box-shadow: 0px 0px 10px 1px rgba(0,0,0,0.8);">
            ...
            <div class="col-12 menu">
                ...
                <li><a href="donations.php.php">Donations</a></li>
        ...
        <div class="col-11" style="height: auto; background: rgba(0,0,0,0.5); float: none; margin: auto; padding: 80px; color: #D4FFD4; position: relative; top: 0px;">
            <h2 style="margin-top: 30px; line-height: 30px; letter-spacing: 3px; text-align: center; text-justify: auto;">
Choosing public welfare over money, working for a noble cause rather than profit, surely deserves a standing ovation and a big round of applause. It’s the NGOs which show a ray of hope to the slums.
We salute you!</h2>

            <h1 style="text-align: center; letter-spacing: 3px;margin-top: 30px;">THANK YOU FOR YOUR SUPPORT! TOGETHER, WE MAKE A DIFFERENCE.
</h1>
