...
<html>
    ...
    <body style="background-image: url(images/page1/backg.jpeg); background-attachment: fixed; background-repeat: no-repeat;background-size: cover;">
        ...
        <div class="col-11" style="height: 525px; background: rgba(0,0,0,0.5); float: none; margin: auto; padding: 80px; color: #D4FFD4; position: relative; top: 0px;">
            <h1 style="text-align: center; letter-spacing: 3px;">Thank you</h1>
            <h2 style="margin-top: 30px; line-height: 30px; letter-spacing: 3px; text-align: center; text-justify: auto;">For making us aware of this Area, we will surely take action within few days.</h2>
            </div>
        </div>
